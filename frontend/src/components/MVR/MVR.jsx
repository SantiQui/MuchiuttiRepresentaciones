...
const MVR = () => {
  return (
    <>
      <div className="content-mvr">
        <div className="w-max">
          <i class="bi bi-bullseye size-home-icons " />
          <h3 class="text-uppercase custom-color-muchiutti fw-bold fs-6">Misión</h3>
          <p>Lograr la mayor distribución numérica y cobertura de calidad.</p>
        </div>
        <div className="w-max">
          <i class="bi bi-eye-fill size-home-icons" />
          <h3 class="text-uppercase custom-color-muchiutti fw-bold fs-6">Visión</h3>
          <p>
        ...
        <div className="w-max">
          ...
          <h3 class="text-uppercase custom-color-muchiutti fw-bold fs-6">Responsabilidad social</h3>
